from .functional import multinomial, masked_mean, mean_with_nan, shifted_softplus, multi_slice_mask, as_mask, \
    _size_to_index, _extend, variadic_log_softmax, variadic_sum, variadic_mean, variadic_max, variadic_cross_entropy, \
    variadic_topk, one_hot, clipped_policy_gradient_objective, policy_gradient_objective
...
__all__ = [
    ...
    "variadic_log_softmax", "variadic_sum", "variadic_mean", "variadic_max", "variadic_cross_entropy",
    "variadic_topk", "one_hot", "clipped_policy_gradient_objective", "policy_gradient_objective",
